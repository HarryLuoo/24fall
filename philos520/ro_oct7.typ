...
#set text(11pt)
#set page(margin: (x: 1cm, y: 1cm),numbering: "1/1", columns: 1, flipped: false)
...
#place(top + right, rect(inset: 3pt)[Philos520 R.O. Harry Luo Oct 8st])
=== Currie *1. Introduction*
- *Context*: Paleoscientists face epistemic scarcity due to extensive temporal scales and information decay.
- *Argument*: Current philosophical accounts prioritize trace-based reasoning but overlook the pervasive use of models. *Objective*: Emphasizes role of models in understanding the deep past
=== *2. Models & Traces*
...
- *Philosophical Accounts*:
  - *Carol Cleland*: "smoking gun" reasoning—correlations, hypothesis generation, and trace discrimination.
  - *Derek Turner*: historical knowledge is underdetermined due to trace decay and lack of intervention capabilities.
...
- *Case Study- MBL Model*: Stochastic branching model for macroevolutionary patterns beyond randomness.
- *Contrast*: Traditional modeling: abstract, v.s. paleoscientific modeling : close to empirical data.
...
- *Key Theses*:- Fidelity, not purity, determines epistemic reliability. - Fidelity is gradual and can be enhanced through model-based corrections.- Data models should be assessed based on their adequacy for specific purposes.
...
- *Approaches to Reading the Fossil Record*: Optimistic (literal) reading vs. corrected (generalized) approaches using models.
